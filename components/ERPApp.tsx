              ...
              <div className="quote-page">
                <div className="doc-header">
                  <div className="doc-brand">
                    <img src={printLogo('Quote')} className="doc-logo" alt="Aashan & Co LLC" />
                    <div>
                ...
                <div className="doc-title-row">
                  <div>
                    <h2>QUOTE</h2>
                    <p><b>Quote #:</b> {printQuote.quote_no}</p>
                    <p><b>Reference:</b> {printQuote.id || ''}</p>
                  </div>
                ...
                <table className="doc-items">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>{Number(printQuote.unit_price || printQuote.amount || 0).toFixed(2)}</td>
                      <td>{Number(printQuote.subtotal || (Number(printQuote.qty || 1) * Number(printQuote.unit_price || printQuote.amount || 0))).toFixed(2)}</td>
                      <td>{Number(printQuote.discount || 0).toFixed(2)}</td>
                      <td>{Number((Number(printQuote.subtotal || 0) - Number(printQuote.discount || 0)) || printQuote.amount || 0).toFixed(2)}</td>
                    </tr>
                  </tbody>
                </table>
                ...
                <div className="doc-terms">
                  ...
                  <p><b>Pricing</b><br />Based on labor hours and material costs at the time of the quote, price variations may apply if materials increase in cost.</p>
                  <p><b>Liability</b><br />Aashan & Co LLC is not liable for indirect losses, such as loss of revenue, profit, or reputation.</p>
          ...
          {printInvoice && (
            <div className="invoice-print">
              <div className="quote-page">
                <div className="doc-header">
                  <div className="doc-brand">
                    <img src={printLogo('Invoice')} className="doc-logo" alt="Aashan & Co LLC" />
                    <div>
