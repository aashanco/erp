-- Aashan ERP Phase 26.4 - Public Document View
-- Allows emailed document links to open only the public document view page.
...
create policy "Public can view quotes from email link"
...
create policy "Public can view invoices from email link"
...
create policy "Public can view receipts from email link"
...
create policy "Public can view customer contact for document link"
...
create policy "Public can view company settings for document link"
